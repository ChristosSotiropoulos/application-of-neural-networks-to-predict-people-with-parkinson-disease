...
classifier.add(Dense(output_dim  = 34, init = 'uniform', activation = 'relu', input_dim = 22))
classifier.add(Dropout(0.5))

# Adding the second hidden layer and the third layer
classifier.add(Dense(output_dim = 34, init = 'uniform', activation = 'relu'))
...
#Number of Neurons
parameters ={'neurons1':[11,16,20,22,34],
             'neurons2':[11,16,20,22,34]}
