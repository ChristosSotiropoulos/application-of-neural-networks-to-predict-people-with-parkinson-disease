...
classifier.add(Dense(output_dim  = 14, init = 'uniform', activation = 'relu', input_dim = 22))
...
#Tunning the ANN
def build_classifier(dropout_rate1,dropout_rate2,dropout_rate3):
    classifier = Sequential()
    ...
    classifier.add(Dense(output_dim = 11, init = 'uniform', activation = 'relu'))
    classifier.add(Dropout(dropout_rate3))
    classifier.add(Dense(output_dim = 1, init = 'uniform', activation = 'sigmoid'))
...
#Number of Neurons
parameters ={'neurons1':[14,16,18],
             'neurons2':[24,26,28],
             'neurons3':[10,11,12]}

#Νumber of Dropout
parameters ={'dropout_rate1' : [ 0.2, 0.4, 0.6],
             'dropout_rate2' : [ 0.2, 0.4, 0.6],
             'dropout_rate3' : [ 0.2, 0.4, 0.6]}
