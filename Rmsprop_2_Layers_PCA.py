...
classifier.add(Dense(output_dim  = 1, init = 'uniform', activation = 'relu', input_dim = 1))
...
def build_classifier(dropout_rate1,dropout_rate2):
    ...
    classifier.add(Dense(output_dim = 3, init = 'uniform', activation = 'hard_sigmoid'))
...
parameters = {'batch_size' : [20,22,25,30],
              'nb_epoch' : [150 ,200,250,500],
             }
...
#Tunning SGD
parameters = {'learn_rate' : [0.001, 0.01, 0.05 ,0.1, 0.3,0.5]}

#Number of Neurons
parameters ={'neurons1':[1,2,3,4],
             'neurons2':[1,2,3,4]}
